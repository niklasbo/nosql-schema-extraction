...
public class NoSQLSchemaWriter {
  ...
  public NoSQLSchemaWriter() {
    ...
    NoSQLSchemaPackage.eINSTANCE.eResource()
        .setURI(URI.createPlatformResourceURI("es.um.nosql.s13e/model/nosqlschema.ecore", true));
  ...
  public void write(NoSQLSchema schema, String outputRoute) {
    ...
    try (var f = new FileOutputStream(outputRoute)) {
      outputRes.save(f, options);
    } catch (IOException e) {
      e.printStackTrace();
    }
  }
